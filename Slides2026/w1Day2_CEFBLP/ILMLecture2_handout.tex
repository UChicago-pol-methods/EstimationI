...
\node<1-2>[anchor=base west] (lhs) at (0,0) {$Y ={}$};
\node<1-2>[anchor=base west] (grpA) at (lhs.base east) {$\beta_0 + \beta_1 x_1 + \beta_2 x_2$};
\node<1-2>[anchor=base west] (plus1) at (grpA.base east) {${}+{}$};
\node<1-2>[anchor=base west] (grpB) at (plus1.base east) {$\beta_3 x_3 + \beta_4 x_4 + \beta_5 x_5$};
\node<1-2>[anchor=base west] (err) at (grpB.base east) {${}+ e$};
