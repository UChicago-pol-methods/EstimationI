...
\begin{frame}{Solving the Partitioned Normal Equations}
The normal equation $\mathbf{Q}_{XY}=\mathbf{Q}_{XX}\beta$ expands into two block rows:
\begin{align}
\mathbf{Q}_{1Y}&=\mathbf{Q}_{11}\beta_1+\mathbf{Q}_{12}\beta_2 \tag{Row 1}\\
\mathbf{Q}_{2Y}&=\mathbf{Q}_{21}\beta_1+\mathbf{Q}_{22}\beta_2 \tag{Row 2}
\end{align}
\pause
\textbf{Goal:} Eliminate $\beta_2$ to isolate $\beta_1$.\\
\medskip
\textbf{Step 1.} Solve Row 2 for $\beta_2$:
$$\beta_2=\mathbf{Q}_{22}^{-1}\bigl(\mathbf{Q}_{2Y}-\mathbf{Q}_{21}\beta_1\bigr)$$
\end{frame}


\begin{frame}{Solving the Partitioned Normal Equations (cont.)}
\textbf{Step 2.} Substitute $\beta_2$ into Row 1:
\begin{align*}
\mathbf{Q}_{1Y}&=\mathbf{Q}_{11}\beta_1+\mathbf{Q}_{12}\mathbf{Q}_{22}^{-1}\bigl(\mathbf{Q}_{2Y}-\mathbf{Q}_{21}\beta_1\bigr)\\\pause
\mathbf{Q}_{1Y}-\mathbf{Q}_{12}\mathbf{Q}_{22}^{-1}\mathbf{Q}_{2Y}&=\bigl(\mathbf{Q}_{11}-\mathbf{Q}_{12}\mathbf{Q}_{22}^{-1}\mathbf{Q}_{21}\bigr)\beta_1
\end{align*}
\pause
\textbf{Step 3.} Recognize the residualized quantities from the previous slide:
\begin{align*}
\underbrace{\mathbf{Q}_{1Y}-\mathbf{Q}_{12}\mathbf{Q}_{22}^{-1}\mathbf{Q}_{2Y}}_{\mathbf{Q}_{1Y\cdot 2}}&=\underbrace{\bigl(\mathbf{Q}_{11}-\mathbf{Q}_{12}\mathbf{Q}_{22}^{-1}\mathbf{Q}_{21}\bigr)}_{\mathbf{Q}_{11\cdot 2}}\beta_1
\end{align*}
\pause
\textbf{Step 4.} Premultiply by $\mathbf{Q}_{11\cdot 2}^{-1}$:
...
The block elimination gave us $\beta=\bm{Q}_{XX}^{-1}\bm{Q}_{XY}$.  What does $\bm{Q}_{XX}^{-1}$ itself look like?\\
\medskip
...
\begin{frame}{Block Inverse: Solving for $\mathbf{M}_{11}$}
From (B), solve for $\mathbf{M}_{21}$:
$$\mathbf{M}_{21}=-\mathbf{Q}_{22}^{-1}\mathbf{Q}_{21}\mathbf{M}_{11}$$
\pause
Substitute into (A):
\begin{align*}
\mathbf{Q}_{11}\mathbf{M}_{11}+\mathbf{Q}_{12}\bigl(-\mathbf{Q}_{22}^{-1}\mathbf{Q}_{21}\mathbf{M}_{11}\bigr)&=\mathbf{I}\\
\bigl(\mathbf{Q}_{11}-\mathbf{Q}_{12}\mathbf{Q}_{22}^{-1}\mathbf{Q}_{21}\bigr)\mathbf{M}_{11}&=\mathbf{I}\\\pause
\mathbf{Q}_{11\cdot 2}\;\mathbf{M}_{11}&=\mathbf{I}
\end{align*}
\pause
$$\boxed{\mathbf{M}_{11}=\mathbf{Q}_{11\cdot 2}^{-1}}$$
And substituting back: $\;\mathbf{M}_{21}=-\mathbf{Q}_{22}^{-1}\mathbf{Q}_{21}\mathbf{Q}_{11\cdot 2}^{-1}$.\\ \medskip
\pause
The same procedure on the second column ($\mathbf{M}_{12}$, $\mathbf{M}_{22}$) gives $\mathbf{M}_{22}=\mathbf{Q}_{22\cdot 1}^{-1}$ and $\mathbf{M}_{12}=-\mathbf{Q}_{11\cdot 2}^{-1}\mathbf{Q}_{12}\mathbf{Q}_{22}^{-1}$.
\end{frame}


\begin{frame}{The Complete Block Inverse}
Collecting all four blocks:
$$\bm{Q}_{XX}^{-1}=\begin{bmatrix} \mathbf{Q}_{11\cdot 2}^{-1} &-\mathbf{Q}_{11\cdot 2}^{-1}\mathbf{Q}_{12}\mathbf{Q}_{22}^{-1}\\ -\mathbf{Q}_{22}^{-1}\mathbf{Q}_{21}\mathbf{Q}_{11\cdot 2}^{-1}&\mathbf{Q}_{22\cdot 1}^{-1}\end{bmatrix}$$
\pause
Now multiply $\bm{Q}_{XX}^{-1}\bm{Q}_{XY}$ to recover our earlier result:
\begin{align*}
\beta_1&=\mathbf{Q}_{11\cdot 2}^{-1}\mathbf{Q}_{1Y}-\mathbf{Q}_{11\cdot 2}^{-1}\mathbf{Q}_{12}\mathbf{Q}_{22}^{-1}\mathbf{Q}_{2Y}\\
&=\mathbf{Q}_{11\cdot 2}^{-1}\bigl(\mathbf{Q}_{1Y}-\mathbf{Q}_{12}\mathbf{Q}_{22}^{-1}\mathbf{Q}_{2Y}\bigr)=\mathbf{Q}_{11\cdot 2}^{-1}\mathbf{Q}_{1Y\cdot 2}\quad\checkmark
\end{align*}
\pause
\begin{itemize}
