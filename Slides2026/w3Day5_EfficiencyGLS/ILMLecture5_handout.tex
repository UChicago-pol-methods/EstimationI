...
\item Can we squeeze more precision out of the data? $\to$ \textbf{Efficiency (Gauss-Markov).}
...
\item Assumption 3: $\mathbb{E}(\bm{x}_i\bm{x}_i')>0$ is invertible (with probability 1).
