...
\begin{frame}{Where Are We? Efficient Estimation}
\begin{itemize}
\item So far: OLS estimates $\beta$ and we have its variance, but \emph{how precise can any estimator be?}\pause
\item The general theory of efficient estimation answers this via \textbf{scores} (derivatives of log-densities) and \textbf{information} (their variance).\pause
...
\section{MLE in the Normal Linear Model}
