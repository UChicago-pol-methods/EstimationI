...
\begin{tcolorbox}[colback=blue!5, colframe=blue!50]
Same structure as Probit MLE: CLT gives the numerator, WLLN/CMT stabilize the denominator, Slutsky combines them.
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item Biased in finite samples, consistent asymptotically --- the canonical biased-but-consistent estimator.
\end{itemize}
\end{frame}
